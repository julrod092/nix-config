...
in {
  ...
  config = mkIf config.hardware.razer-nari.enable {
    ...
    environment.etc = {
      ...
      "alsa-card-profile/mixer/paths/razer-nari-input.conf".source = "${razer-nari-profiles}/razer-nari-input.conf";
      "alsa-card-profile/mixer/paths/razer-nari-output-game.conf".source = "${razer-nari-profiles}/razer-nari-output-game.conf";
      "alsa-card-profile/mixer/paths/razer-nari-output-chat.conf".source = "${razer-nari-profiles}/razer-nari-output-chat.conf";

      # ALSA card profile sets
      "alsa-card-profile/mixer/profile-sets/razer-nari-usb-audio.conf".source = "${razer-nari-profiles}/razer-nari-usb-audio.conf";
    };
